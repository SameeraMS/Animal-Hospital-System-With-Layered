...
public class SystemAlert extends Alert {
    ...
    public SystemAlert(AlertType alertType, String title, String message, ButtonType... buttonTypes) {
        ...
        switch (alertType){
            case ERROR:
                image = "src/main/resources/asserts/images/alert/error.gif";
                break;
            case INFORMATION:
                image = "src/main/resources/asserts/images/alert/info.gif";
                break;
            case WARNING:
                image = "src/main/resources/asserts/images/alert/warning.gif";
                break;
            case CONFIRMATION:
                image = "src/main/resources/asserts/images/alert/confirmation.gif";
                break;
            case NONE:
                image = "src/main/resources/asserts/images/alert/connection_error.gif";
                break;
        }

        if (image != null){
            if (title.equals("Email")){
                image = "src/main/resources/asserts/images/alert/send_mail.gif";
            }else if(title.equals("Logout")){
                image = "src/main/resources/asserts/images/alert/logout.gif";
            }
